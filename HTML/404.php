    ...
    <body>
        ...
        <div id="main-wrap">
            ...
            <div id="page-content" class="header-static">
                <!--  Page Header  -->
                <div id="post-header">
                    <div class="bg-image" style="background-image:url(assets/img/ApplicationBureau.jpg)"></div>
                    <div class="container">
                        <div class="row no-margin">
                            <div class="text secondary-background">
                                <div class="post-meta padding-onlybottom-md">
                                    ...
                                    <span class="date white">Nous ne pouvons pas trouver la page que vous recherchez.</span>
                                </div>
                                <a href="index.php" class="btn-alt small white margin-null">Retour à l'accueil</a>
                            </div>
                        </div>
                    </div>
                </div>
