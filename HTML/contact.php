                                            ...
                                            <form id="contact-form">
                                                <div class="row no-margin">
                                                    <div class="col-md-12 padding-leftright-null">
                                                        ...
                                                        <input class="form-field" name="name" id="name" type="text" placeholder="Votre Nom">
                                                    </div>
                                                    <div class="col-md-12 padding-leftright-null">
                                                        <label for="mail">Email<sup>*</sup></label>
                                                        <input class="form-field" name="mail" id="mail" type="text" placeholder="Votre Email">
                                                    </div>
                                                </div>
                                                <div class="row no-margin">
                                                    <div class="col-md-12 padding-leftright-null">
                                                        <label for="messageForm">Message<sup>*</sup></label>
                                                        <textarea class="form-field" name="messageForm" id="messageForm" rows="6" placeholder="Votre Message"></textarea>
                                                        <div class="submit-area padding-onlytop-sm">
                                                            <input type="submit" id="submit-contact" class="btn-alt active shadow" value="Envoyer Message">
                                ...
                                <div class="col-md-7 padding-leftright-null">
                                    <div class="row no-margin padding-onlytop-md">
                                        <div class="col-md-6 padding-leftright-null">
                                            <div class="text padding-md-top-null">
                                                <h3 class="margin-bottom-small">Visitez nous sur :</h3>
                                                <p class="margin-null">61 Avenue Lalla Yacout Mustapha El Maani,
                                                                    Centre Commercial Riad N°85 2éme Etage Casablanca, Maroc</p>
                                            </div>
                                        </div>
                                        <div class="col-md-6 padding-leftright-null">
                                            <div class="text padding-md-top-null">
                                               <h3 class="margin-bottom-small">Appelez-nous</h3>
                                                <p class="margin-bottom-extrasmall"><a href="" class="simple">+212 614-669052
                                                   </a></p>
                                               <p class="margin-null"><a href="" class="simple">+212 661-327752</a></p>
                                           </div>
                                        </div>
                                    </div>
                                    <div class="row no-margin">
                                        <div class="col-md-6 padding-leftright-null">
                                            <div class="text padding-md-top-null">
                                                <h3 class="margin-bottom-small">Ecrivez nous sur :</h3>
                                                <p class="margin-bottom-extrasmall"><a href="" class="simple">info@lighthouse.ma</a></p>
                                            </div>
                                        </div>
                                        <div class="col-md-6 padding-leftright-null">
                                            <div class="text padding-md-top-null padding-md-bottom-null">
                                                <h3 class="margin-bottom-small">Commencez un projet avec nous</h3>
                                                <p class="margin-bottom-extrasmall">Light House Technology offre des solutions personnalisées et adaptées à nos clients. </p>
                                            </div>
                                        </div>
                                    </div>
                                </div>
